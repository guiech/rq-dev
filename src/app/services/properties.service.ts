...
export class PropertiesService {
  ...
  PROPS:Property[] = [
      ...
      {id: 4, title: 'Casa 4', description: 'Descripcion de la casa 4', price: 4000, currency: 'ARS', user: this.user, images:['assets/images/casa3.jpg','assets/images/casa2.jpg','assets/images/casa1.jpg'], lat: -31.4199755, lng: -64.4977119,city: 'Villa Carlos Paz', state: 'Córdoba', acommodationType: 'Casa', bedRooms: 1, bathRooms: 1, realState: false},
      {id: 5, title: 'Casa 5', description: 'Descripcion de la casa 5', price: 1000, currency: 'ARS', user: this.user, images:[], lat: -31.4255934, lng: -64.4954727, city: 'Villa Carlos Paz', state: 'Córdoba', acommodationType: 'Casa', bedRooms: 1, bathRooms: 1, realState: false},
      {id: 6, title: 'Casa 6', description: 'Descripcion de la casa 6', price: 2000, currency: 'ARS', user: this.user, images:['assets/images/casa1.jpg'], lat: -31.4274042, lng: -64.4952885, city: 'Villa Carlos Paz', state: 'Córdoba', acommodationType: 'Casa', bedRooms: 1, bathRooms: 1, realState: false},
